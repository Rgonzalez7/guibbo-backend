...
const CRITERIOS_HABILIDAD = {
  pregunta_abierta: {
    nivel_1: {
      objetivo: "Facilitar que el paciente amplíe su discurso mediante preguntas abiertas simples, priorizando la exploración de su experiencia interna (pensamientos y emociones), sin interpretar ni imponer contenido.",

      criterios_adecuada: [
        "Es una pregunta abierta (no se responde con sí/no)",
        "Inicia preferentemente con 'qué' o 'cómo' (o formulaciones equivalentes)",
        "Permite múltiples posibles respuestas (no limita a una sola dirección)",
        "Explora experiencia interna (pensamientos, emociones o vivencias del paciente)",
        "Puede explorar emociones o pensamientos aunque no hayan sido mencionados explícitamente, siempre que no imponga interpretación ni significado",
        "No contiene hipótesis, causas ni explicaciones dentro de la pregunta",
        "No introduce diagnósticos ni etiquetas",
        "No dirige la respuesta hacia una conclusión específica",
        "Se mantiene conectada con el contenido expresado por el paciente",
        "Es clara, simple y con una sola intención",
      ],

      criterios_parcial: [
        "Es una pregunta abierta pero se mantiene en un nivel descriptivo (tiempo, lugar, frecuencia) sin explorar experiencia interna",
        "Es abierta pero demasiado general (por ejemplo: '¿a qué te refieres?')",
        "Es abierta pero poco precisa o débilmente conectada con el contenido del paciente",
        "Explora experiencia interna pero de forma vaga o poco clara",
        "Incluye más de una intención (pregunta doble) pero sigue siendo mayormente abierta",
        "La pregunta es válida pero aporta poca profundidad clínica",
      ],

      criterios_incorrecta: [
        "Es una pregunta cerrada (se responde con sí/no)",
        "Incluye estructuras que introducen hipótesis o causa (por ejemplo: '¿crees que es porque...?', '¿será que...?', '¿por qué...?')",
        "Impone una emoción, pensamiento o significado no dicho por el paciente (por ejemplo: '¿te sientes ansioso?', '¿esto te genera inseguridad?')",
      ...
      errores_tipicos: [
        ...
        "Hacer preguntas de causa ('por qué', 'se debe a')",
        "Imponer emociones o significados no expresados",
        "Quedarse en preguntas descriptivas (tiempo, lugar, frecuencia)",
      ...
      lineamientos_correccion: [
        ...
        "Dirigir la pregunta hacia la experiencia interna (pensamientos, emociones o vivencias)",
        "Eliminar cualquier hipótesis, causa o explicación dentro de la pregunta",
        "Eliminar diagnósticos o interpretaciones",
        "Evitar imponer emociones o significados",
        "Mantener una sola intención clara",
        "Priorizar profundidad (experiencia interna) sobre descripción externa",
        "Asegurar claridad y conexión con lo dicho por el paciente",
      ],

      reglas_decision_critica: [
        "Si la pregunta contiene 'porque', 'se debe a', 'crees que', 'será que', 'por qué' → INCORRECTA",
        "Si puede responderse con sí/no → INCORRECTA",
        "Si impone una emoción o significado no dicho → INCORRECTA",
        "Si es abierta pero se limita a información descriptiva (tiempo, lugar, frecuencia) → PARCIAL",
        "Si es abierta pero muy general → PARCIAL",
        "Si es abierta, explora experiencia interna y no dirige → ADECUADA",
      ],

      reglas_alternativas: [
        "Las alternativas deben ser siempre preguntas abiertas",
        "Deben iniciar preferentemente con 'qué' o 'cómo'",
        "Deben explorar experiencia interna (emociones, pensamientos o vivencias)",
        "No deben incluir hipótesis ni causas",
        "No deben introducir diagnósticos ni etiquetas",
        "No deben imponer emociones o significados",
        "Deben mejorar profundidad y claridad respecto a la respuesta original",
      ],
    },
